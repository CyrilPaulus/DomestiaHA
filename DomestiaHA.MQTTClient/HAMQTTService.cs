...
{
    internal class HAMQTTService
    {
        private readonly IDomestiaLightService _domestiaLightService;
        private readonly IEnumerable<LightConfiguration> _lights;

        public HAMQTTService(IDomestiaLightService domestiaLightService, IEnumerable<LightConfiguration> lights)
        {
            _domestiaLightService = domestiaLightService;
            _lights = lights;
        }
        ...
        private Task Client_ApplicationMessageReceivedAsync(MqttApplicationMessageReceivedEventArgs arg)
        {
            ...
            var regex = new Regex("domestia/light/(.*)/set");
        ...
        public string GetLightId(LightConfiguration lightConfiguration)
        {
